<?php
class model_Projects extends abstract_model{
	
	protected $sClassRow='row_Projects';
	
	protected $sTable='kProjects';
...
class row_Projects extends abstract_row{
	
	protected $sClassModel='model_Projects';
